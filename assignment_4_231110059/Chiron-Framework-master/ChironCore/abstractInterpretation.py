...
class AbstractInterpreter(Interpreter):
    ...
    #just a dummy equallity check functionir
    ...
    def worklistAlgorithm(self, cfg):
        ...
        for i in BBlist:            # i in BBList is variable for nodes like START,END,1,2,3
            # print(i)
        ...
        while not self.workList.isEmpty():
            ...
            for pred in predList:
                ...
                if bbOut[pred.name]:
                    if label != 'Cond_False':                    # I change this from T to flow_edge
